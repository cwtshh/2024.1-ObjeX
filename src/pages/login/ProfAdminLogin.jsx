...
const ProfAdminLogin = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    if(await login({ email, senha }, 'admin')) {
      navigate('/professor/admin/dashboard');
      return;
    }
        ...
        <div className='p-6 flex items-center justify-center'>
          <div className='card bg-base-100 w-96 shadow-xl'>
            <div className='card-body items-center text-center'>
              ...
              <form onSubmit={handleSubmit} className='flex flex-col col-span-1 gap-4 mt-6'>
                ...
                <label className="input input-bordered flex items-center gap-2">
                  ...
                  <input onChange={e => setSenha(e.target.value)} type="password" className="grow" placeholder='Senha' />
                </label>
