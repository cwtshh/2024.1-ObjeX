            ...
            <div className='pl-20 pr-20 md:pt-[100px] pt-[10px] flex items-center justify-center'>
                <div className="card bg-base-100 shadow-2xl">
                    ...
                    <div className="card-body pl-[35px] pt-[35px] rounded-b-xl w-full h-1/4 bg-base-100">
                        ...
                        <button type='submit' className='btn btn-primary mt-4 text-base-100 font-bold w-1/2 h-[55px] self-center'>{isLoading ? <Loading /> : "Logar"}</button>
                        </form>
                    </div>
                </div>
            ...
            <div className='pl-8 pr-8 pt-[16px] mb-[100px] flex items-center justify-center'>
                <div className="pl-5 pr-5 card bg-base-100 shadow-2xl">
                    <div className='flex flex-col items-center p-5 gap-4'> 
                        ...
                        <button onClick={() => navigate('/primeiroacesso')} className='btn btn-secondary text-base-100 font-bold mb-1'>{isLoading ? <Loading /> : "Primeiro acesso"}</button>
                    </div>
                </div>
            </div>
            <ToastContainer />
