            ...
            <div className='z-[1] flex justify-center pt-[10px] md:h-[85vh] overflow-y-auto'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 3xl:grid-cols-4 overflow-y-hidden md:overflow-y-scroll z-[1] gap-4 p-4'>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 1</p>
                      ...
                      <p className='text-md text-[#2e3440] relative bottom-[180px] ml-[10px] w-[250px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit veritatis rerum quas dicta atque!</p>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 2</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 3</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 4</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 5</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 6</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 7</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 8</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 9</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 10</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 11</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
                  ...
                  <div className="bg-base-100 shadow h-[200px] w-[300px] rounded-xl">
                    ...
                    <div className=''>
                      <div className='flex'>
                        <p className='text-xl text-[#2e3440] m-[10px] w-[250px]'>Grupo 12</p>
                        <svg width="125px" height="100px">
                            <ellipse cx="50%" cy="50%" rx="50%" ry="50%" fill="#d8dee9"/>
                            <rect x="0%" y="0%" width="100%" height="50%" fill="#d8dee9"/>
                          </svg>
