        ...
        <div className='bg-base-200'>
                    ...
                    <div className="bg-base-100 md:ml-[280px] w-[85vw] h-[85vh] shadow z-[1] rounded-xl md:mb-8 mb-20 md:mt-0 mt-8 items-center align-middle justify-center">
                        ...
                        <div className='flex flex md:flex-row flex-col items-center justify-between md:pr-12 md:px-0 px-3'>
                            ...
                            <div className='flex gap-4 md:mb-0 mb-4 md:w-auto w-full'>
                                <button onClick={()=>document.getElementById('my_modal_2').showModal()} className='btn btn-primary text-white md:w-auto w-full'>
            ...
            <div className="modal-box flex flex-col justify-center items-center">
                ...
                <form onSubmit={handleCreateAtividade} method='dialog' className='flex flex-col justify-center gap-2 w-3/4'>
                    ...
                    <button type='submit' onClick={()=>document.getElementById('my_modal_2').close()} className='btn btn-primary text-white'>Criar Atividade</button>
                </form>
            </div>
