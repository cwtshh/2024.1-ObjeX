  ...
  return (
    <div>
      ...
      <div className='flex justify-center'>
          <div className=' flex flex-col md:flex-row absolute md:left-[50px] md:w-[92vw]'>
            <div className="bg-base-100 md:w-[250px] w-[85vw] md:h-[85vh] shadow ml-50 z-[1] rounded-xl">
          ...
          <div className='flex flex-col h-[85vh] w-auto z-[1] m-[25px]'>
